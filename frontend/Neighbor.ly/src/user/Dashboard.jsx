    ...
    <div className='w-full mx-auto'>
      <section className='mb-8 p-4 rounded-xl bg-gray-200'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8'>
          ...
          <div className='bg-yellow-300 border py-10 border-yellow-200 hover:scale-105 cursor-pointer transition rounded-xl p-6 text-center' onClick={() => navigate("/members")}>
              <div className='mx-auto h-12 w-12 rounded-full bg-yellow-200 flex items-center justify-center'>
                  <span><UserPlus size={22} /></span>
              </div>
              <h3 className='text-yellow-700 font-bold text-xl'>Society Members</h3>
